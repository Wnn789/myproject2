...
nb_train_samples = len(os.listdir('data/train'))
nb_validation_samples = len(os.listdir('data/validation'))
epochs = 2
batch_size = 10
...
callbacks_list = [checkpoint, [checkpoint,TensorBoard(log_dir='log_dir')]]
